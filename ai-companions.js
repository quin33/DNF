...
(function (root, factory) {
  ...
  const skills = {
    liguijian: { name: '里鬼剑术', type: '物理技', elem: '', tier: '普通', desc: '基础剑法，横斩斜挑一气呵成，收势之间暗藏杀机。' },
    sanduanzhan: { name: '三段斩', type: '物理技', elem: '', tier: '普通', desc: '收剑、送肩、连斩三击，借势前突，地下城起手最稳的一招。' },
    guizhan: { name: '鬼斩', type: '物理技', elem: '', tier: '普通', desc: '凝怨气于兵刃，一刀劈下，鬼影森森。' },
    yueguangzhan: { name: '月光斩', type: '物理技', elem: '', tier: '高级', desc: '剑光如一弯月牙横掠，清冷而致命。' },
    bengquan: { name: '崩拳', type: '物理技', elem: '', tier: '普通', desc: '蓄力一击，拳出如崩山，将面前敌人打得踉跄后退。' },
    beishuai: { name: '背摔', type: '物理技', elem: '', tier: '普通', desc: '贴身擒抱，借力把敌人掼向地面，土石四溅。' },
    tieshankao: { name: '铁山靠', type: '物理技', elem: '', tier: '高级', desc: '以肩为锋，沉身撞出，把人连盾带人轰开半丈。' },
    jialin: { name: '加特林扫射', type: '物理技', elem: '', tier: '高级', desc: '架起重型枪械一顿扫射，弹雨压得敌人抬不起头。' },
    yindan: { name: '银弹', type: '魔法技', elem: '', tier: '普通', desc: '给弹头附上圣光，破邪驱魔，击中要害时格外疼痛。' },
    futan: { name: '浮空弹', type: '物理技', elem: '', tier: '普通', desc: '一发挑射把敌人抬离地面，为后续连击留出空档。' },
    moli: { name: '魔力弹', type: '魔法技', elem: '', tier: '普通', desc: '指尖凝出一颗刺目的魔力弹，折线扑向敌人。' },
    huoqiu: { name: '火球术', type: '魔法技', elem: '', tier: '普通', desc: '聚一团赤焰火球掷出，落地爆开，灼浪翻涌。' },
    bingxue: { name: '冰霜雪人', type: '魔法技', elem: '', tier: '高级', desc: '召出一只圆滚滚的冰霜雪人扑向敌人，撞碎时寒气四溢。' },
    shengguang: { name: '圣光十字', type: '物理技', elem: '', tier: '普通', desc: '以十字架划出一道圣光，正面镇压扑来的魔物。' },
    zhiyu: { name: '治愈术', type: '魔法技', elem: '', tier: '高级', desc: '引导圣光疗愈伤势，让人在恶战中喘一口气。' },
    luolei: { name: '落雷符', type: '魔法技', elem: '', tier: '普通', desc: '掷出一道符纸召来落雷，噼啪一声焦了敌手。' },
  };
  ...
  const cards = [
    {
      ...
      personality: '高傲', traits: ['剑心通明', '初入阿拉德'],
      traitDescs: { '剑心通明': '与剑意天然相合，遇剑便知其锋芒。', '初入阿拉德': '初入地下城的冒险家，正磨砺着第一块伤疤。' },
    ...
    },
    {
      ...
      personality: '明哲', traits: ['信仰坚定', '百毒不侵'],
      traitDescs: { '信仰坚定': '认定的事绝不回头，圣光从来只差她一个念头。', '百毒不侵': '幼时服用过圣泉，寻常瘴毒难近其身。' },
    ...
    },
    {
      ...
      personality: '莽撞', traits: ['血性', '胆大心细'],
      traitDescs: { '血性': '越战越狂，伤口反而让他更兴奋。', '胆大心细': '看着莽撞，遇险时反而比谁都沉得住气。' },
    ...
    },
    {
      ...
      personality: '好奇', traits: ['博闻强记', '图书馆常客'],
      traitDescs: { '博闻强记': '过目不忘，凡看过的残卷碑文皆能默诵。', '图书馆常客': '赫顿玛尔图书馆的熟面孔，靠翻书也练出半身本领。' },
    ...
    },
    {
      ...
      personality: '孤僻', traits: ['夜视之眼', '硬拳'],
      traitDescs: { '夜视之眼': '在黑暗处视物如昼，暗巷深窟皆可来去。', '硬拳': '拳风扎实，挨上一记可不是闹着玩的。' },
    ...
    },
    {
      ...
      personality: '重诺', traits: ['老练猎手', '圣盾意志'],
      traitDescs: { '老练猎手': '常在林中穿行，辨足迹、寻猎物皆有一手。', '圣盾意志': '圣光凝成的信念，护得住身后人。' },
    ...
    },
    {
      ...
      personality: '狡诈', traits: ['寻宝直觉', '枪法刁钻'],
      traitDescs: { '寻宝直觉': '对暗格秘藏有近乎本能的嗅觉。', '枪法刁钻': '专挑要害去，一枪一个准头。' },
    ...
    },
    {
      ...
      personality: '仗义', traits: ['听风辨位', '柔劲'],
      traitDescs: { '听风辨位': '凭风声与脚步便能辨明四周动向。', '柔劲': '借力打力，四两拨千斤。' },
    ...
    },
    {
      ...
      personality: '明哲', traits: ['弹药储备', '百毒不侵'],
      traitDescs: { '弹药储备': '总能从身上掏出一发恰到好处的子弹。', '百毒不侵': '多年行军打仗，寻常毒物已奈何不得。' },
    ...
    },
    {
      ...
      personality: '好奇', traits: ['元素亲和', '灵觉敏锐'],
      traitDescs: { '元素亲和': '举手投足便能引动火风水雷。', '灵觉敏锐': '对魔力波动异常敏感，异动未至已先觉。' },
      skills: [skills.moli, skills.huoqiu, skills.bingxue], skillPool: [],
    ...
    },
    {
      ...
      personality: '孤僻', traits: ['冰冷气息', '心狠手辣'],
      traitDescs: { '冰冷气息': '出手必带寒意，连血都凝成红晶。', '心狠手辣': '对敌人绝不手软，出手不留余情。' },
    ...
    },
    {
      ...
      personality: '仗义', traits: ['契约召唤', '气运缠身'],
      traitDescs: { '契约召唤': '与小妖精订过契，挥手便能唤来帮手。', '气运缠身': '常与机缘不期而遇，也常被麻烦缠上。' },
